...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.Video/1.0.2/$.uno
// ---------------------------------------------------------------------------------------------------
...
static void VideoVisual_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.Video/1.0.2/$.uno");
...
void VideoVisual__FuseControlsVideoImplIVideoCallbacksOnError_fn(VideoVisual* __this, ::g::Uno::Exception* e)
{
    ...
    ::g::Fuse::Diagnostics::UnknownException(::STRINGS[5/*"Video error"*/], e, __this, ::STRINGS[6/*"/Users/mart...*/], 1081, ::STRINGS[7/*"Fuse.Contro...*/]);
}
...
{
    ::g::Fuse::Diagnostics::Unsupported(::STRINGS[9/*"IPlayback.P...*/], __this, ::STRINGS[6/*"/Users/mart...*/], 1130, ::STRINGS[10/*"Fuse.Trigge...*/]);
}
