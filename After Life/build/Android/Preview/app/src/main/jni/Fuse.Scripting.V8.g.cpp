...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Scripting.V8/1.0.2/$.uno
// -------------------------------------------------------------------------------------------------
...
static void Debugger__Connected_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("../../../Library/Application Support/Fusetools/Packages/Fuse.Scripting.V8/1.0.2/$.uno");
...
void Debugger__Connected::ctor_(::g::Fuse::Scripting::V8::Debugger* parent, ::g::Uno::Net::Sockets::Socket* socket, ::g::Uno::IO::TextReader* reader)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"DEBUG_V8: C...*/], 1, ::STRINGS[1/*"../../../Li...*/], 635);
    _parent = parent;
    _socket = socket;
    _reader = reader;
}
...
static void Debugger_build(uType* type)
{
    ...
    ::STRINGS[20] = uString::Const("1.0.2");
...
uObject* Debugger::Connect(Debugger* parent)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[14/*"DEBUG_V8: W...*/], uBox<int>(::TYPES[19/*int*/], parent->_port)), ::STRINGS[15/*"..."*/]), 1, ::STRINGS[1/*"../../../Li...*/], 476);
