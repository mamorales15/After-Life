...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Motion/1.0.2/$.uno
// -------------------------------------------------------------------------------------------
...
static void DestinationMotion_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Motion/1.0.2/$.uno");
...
uObject* DestinationMotion::Create()
{
    ...
    switch (Type())
    {
        ...
        default:
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition1(::STRINGS[0/*"Invalidate ...*/], uBox<int>(::g::Fuse::Motion::MotionDestinationType_typeof(), Type())), this, ::STRINGS[1/*"/Users/mart...*/], 401, ::STRINGS[2/*"Create"*/], NULL);
