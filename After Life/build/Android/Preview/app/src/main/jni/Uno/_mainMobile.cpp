...
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* AfterLife_accessor_Song_File_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* AfterLife_accessor_Song_Label_typeof();}
namespace g{uClassType* AfterLife_bundle_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* AfterLife_FuseControlsTextControl_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* AfterLife_FusePlaySound_File_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* AfterLife_Song_File_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* AfterLife_Song_Label_Property_typeof();}
namespace g{namespace Fuse{struct AppBase_type;} ::g::Fuse::AppBase_type* MainView_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* Song_typeof();}
...
namespace g{namespace Experimental{namespace Audio{struct Channel_type; Channel_type* Channel_typeof();}}}
namespace g{namespace Experimental{namespace Audio{uType* ChannelHandle_typeof();}}}
namespace g{namespace Experimental{namespace Audio{uType* ChannelImpl_typeof();}}}
namespace g{namespace Experimental{namespace Audio{struct Player_type; Player_type* Player_typeof();}}}
namespace g{namespace Experimental{namespace Audio{uType* PlayerHandle_typeof();}}}
namespace g{namespace Experimental{namespace Audio{uType* PlayerImpl_typeof();}}}
namespace g{namespace Experimental{namespace Audio{uType* Sound_typeof();}}}
namespace g{namespace Experimental{namespace Audio{uType* SoundHandle_typeof();}}}
namespace g{namespace Experimental{namespace Audio{uType* SoundImpl_typeof();}}}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::AfterLife_accessor_Song_File_typeof,
        (uType*(*)())&::g::AfterLife_accessor_Song_Label_typeof,
        (uType*(*)())&::g::AfterLife_bundle_typeof,
        (uType*(*)())&::g::AfterLife_FuseControlsTextControl_Value_Property_typeof,
        (uType*(*)())&::g::AfterLife_FusePlaySound_File_Property_typeof,
        (uType*(*)())&::g::AfterLife_Song_File_Property_typeof,
        (uType*(*)())&::g::AfterLife_Song_Label_Property_typeof,
        ...
        (uType*(*)())&::g::Experimental::Audio::Channel_typeof,
        (uType*(*)())&::g::Experimental::Audio::ChannelHandle_typeof,
        (uType*(*)())&::g::Experimental::Audio::ChannelImpl_typeof,
        (uType*(*)())&::g::Experimental::Audio::Player_typeof,
        (uType*(*)())&::g::Experimental::Audio::PlayerHandle_typeof,
        (uType*(*)())&::g::Experimental::Audio::PlayerImpl_typeof,
        (uType*(*)())&::g::Experimental::Audio::Sound_typeof,
        (uType*(*)())&::g::Experimental::Audio::SoundHandle_typeof,
        (uType*(*)())&::g::Experimental::Audio::SoundImpl_typeof,
