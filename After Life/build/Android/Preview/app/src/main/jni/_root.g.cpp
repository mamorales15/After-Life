...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls/1.0.2/.uno/package
// ----------------------------------------------------------------------------------------------------
...
{
    FuseControls_bundle::SolidRectangle170ae5e6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[2/*"uniform mat...*/], ::STRINGS[3/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[14/*"l"*/]));
    FuseControls_bundle::SolidRectangle2f148815_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[15/*"uniform mat...*/], ::STRINGS[16/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 9, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/]));
    FuseControls_bundle::SolidRectangle7463714b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[17/*"uniform mat...*/], ::STRINGS[18/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/]));
    FuseControls_bundle::SolidRectangled1bbfcb0_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[19/*"uniform mat...*/], ::STRINGS[20/*"uniform vec...*/], 2, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 18, ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[4/*"a"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[21/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[22/*"m"*/], ::STRINGS[23/*"n"*/], ::STRINGS[24/*"o"*/], ::STRINGS[25/*"p"*/], ::STRINGS[26/*"q"*/], ::STRINGS[27/*"t"*/]));
    FuseControls_bundle::Viewportd3ce851b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[28/*"uniform mat...*/], ::STRINGS[29/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[8/*"e"*/]));
}

static void FuseControls_bundle_build(uType* type)
{
    ::STRINGS[2] = uString::Const("uniform mat4 g, b;\n"
        "uniform vec2 c, d, i;\n"
        "uniform vec4 h;\n"
        "uniform float j;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[3] = uString::Const("uniform float e, f;\n"
        "\n"
        "uniform sampler2D l;\n"
        "\n"
        "varying float k;\n"
    ...
    ::STRINGS[15] = uString::Const("uniform mat4 i, b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        "varying vec2 j;\n"
        ...
        "}\n"
        "");
    ::STRINGS[16] = uString::Const("uniform vec2 c, d;\n"
        "uniform float e, g, h;\n"
        "uniform vec4 f;\n"
        "\n"
        "varying vec2 j;\n"
    ...
    ::STRINGS[28] = uString::Const("uniform mat4 c, b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        "varying vec2 d;\n"
        ...
        "}\n"
        "");
    ::STRINGS[29] = uString::Const("uniform sampler2D e;\n"
        "\n"
        "varying vec2 d;\n"
        "\n"
        "void main()\n"
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.Native/1.0.2/.uno/package
// -----------------------------------------------------------------------------------------------------------
...
{
    FuseControlsNative_bundle::Blitter65ac1d08_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[30/*"uniform vec...*/], ::STRINGS[31/*"uniform sam...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 6, ::STRINGS[5/*"b"*/], ::STRINGS[4/*"a"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[11/*"h"*/]));
    FuseControlsNative_bundle::Blitterbdb4a41b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[32/*"uniform vec...*/], ::STRINGS[33/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[9/*"f"*/]));
}

static void FuseControlsNative_bundle_build(uType* type)
{
    ::STRINGS[30] = uString::Const("uniform vec2 d, c;\n"
        "uniform mat4 e;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
    ...
    ::STRINGS[32] = uString::Const("uniform vec2 c, b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[33] = uString::Const("uniform sampler2D f;\n"
        "\n"
        "varying vec2 e;\n"
        "\n"
        "void main()\n"
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/1.0.2/.uno/ux11/$.uno
// ------------------------------------------------------------------------------------------------------------------
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.Panels/1.0.2/.uno/package
// -----------------------------------------------------------------------------------------------------------
...
{
    FuseControlsPanels_bundle::FreezeDrawable1e2faccf_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[34/*"uniform mat...*/], ::STRINGS[35/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[9/*"f"*/]));
}
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/1.0.2/.uno/ux11/$.uno
// ------------------------------------------------------------------------------------------------------------------
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/1.0.2/.uno/package
// ---------------------------------------------------------------------------------------------------------------
...
{
    FuseControlsPrimitives_bundle::ImageElementDraw7660063a_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[38/*"uniform mat...*/], ::STRINGS[39/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[11/*"h"*/]));
}
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/1.0.2/.uno/ux11/$.uno
// ------------------------------------------------------------------------------------------------------------------
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.Video/1.0.2/.uno/package
// ----------------------------------------------------------------------------------------------------------
...
{
    FuseControlsVideo_bundle::Scale9Rectangleda875692_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[41/*"uniform flo...*/], ::STRINGS[42/*"uniform sam...*/], 0, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[21/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[22/*"m"*/], ::STRINGS[23/*"n"*/], ::STRINGS[24/*"o"*/], ::STRINGS[26/*"q"*/]));
    FuseControlsVideo_bundle::VideoDrawElement5c829975_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[43/*"uniform mat...*/], ::STRINGS[44/*"uniform sam...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[5/*"b"*/], ::STRINGS[4/*"a"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[11/*"h"*/]));
}
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Drawing/1.0.2/.uno/package
// ---------------------------------------------------------------------------------------------------
...
{
    FuseDrawing_bundle::LinearGradientDrawable479fd075_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[45/*"attribute v...*/], ::STRINGS[46/*"uniform flo...*/], 3, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[4/*"a"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/]));
}
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Drawing.Primitives/1.0.2/.uno/package
// --------------------------------------------------------------------------------------------------------------
...
static void FuseDrawingPrimitives_bundle__cctor__fn(uType* __type)
{
    ...
    FuseDrawingPrimitives_bundle::Circlee8ef393e_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[93/*"uniform vec...*/], ::STRINGS[94/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 15, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[21/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[22/*"m"*/], ::STRINGS[23/*"n"*/], ::STRINGS[24/*"o"*/]));
    ...
    FuseDrawingPrimitives_bundle::Circlef7c3f433_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[102/*"uniform vec...*/], ::STRINGS[103/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 8, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/]));
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Drawing.Surface/1.0.2/.uno/package
// -----------------------------------------------------------------------------------------------------------
...
static void FuseDrawingSurface_bundle__cctor__fn(uType* __type)
{
    ...
    FuseDrawingSurface_bundle::Surface541b21c2_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[28/*"uniform mat...*/], ::STRINGS[29/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[8/*"e"*/]));
}
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Effects/1.0.2/.uno/package
// ---------------------------------------------------------------------------------------------------
...
{
    FuseEffects_bundle::Blitter6e650d31_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[140/*"uniform mat...*/], ::STRINGS[141/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[11/*"h"*/]));
    FuseEffects_bundle::Blur115443aa_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[28/*"uniform mat...*/], ::STRINGS[29/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[8/*"e"*/]));
    FuseEffects_bundle::Desaturate88bb7f94_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[34/*"uniform mat...*/], ::STRINGS[142/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[9/*"f"*/]));
    FuseEffects_bundle::Duotone26eb7e3c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[140/*"uniform mat...*/], ::STRINGS[143/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[11/*"h"*/]));
    FuseEffects_bundle::EffectHelpers52052d40_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[144/*"attribute v...*/], ::STRINGS[145/*"uniform flo...*/], 3, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[4/*"a"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[11/*"h"*/]));
    ...
    FuseEffects_bundle::EffectHelpersd8c2e3e5_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[147/*"uniform vec...*/], ::STRINGS[148/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[27/*"t"*/]));
    FuseEffects_bundle::EffectHelperse7e608d1_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[149/*"uniform vec...*/], ::STRINGS[150/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 8, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[22/*"m"*/]));
    FuseEffects_bundle::Halftone3c4c510c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[151/*"uniform mat...*/], ::STRINGS[152/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[21/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[22/*"m"*/], ::STRINGS[26/*"q"*/]));
    FuseEffects_bundle::Mask0da73af7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[153/*"uniform mat...*/], ::STRINGS[154/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/]));
    FuseEffects_bundle::Mask6affc65c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[153/*"uniform mat...*/], ::STRINGS[155/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/]));
    FuseEffects_bundle::Maskb04eaf92_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[153/*"uniform mat...*/], ::STRINGS[156/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/]));
}
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/.uno/package
// ----------------------------------------------------------------------------------------------------
...
{
    FuseElements_bundle::CacheHelper230c69b7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[157/*"uniform vec...*/], ::STRINGS[158/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 6, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[10/*"g"*/]));
    FuseElements_bundle::ElementBatchd43eeb4e_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[159/*"uniform mat...*/], ::STRINGS[160/*"uniform sam...*/], 0, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[9/*"f"*/]));
    FuseElements_bundle::ElementDraw1f583284_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[17/*"uniform mat...*/], ::STRINGS[18/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/]));
    FuseElements_bundle::RepeatBaker447c61dc_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[161/*"uniform vec...*/], ::STRINGS[162/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[8/*"e"*/]));
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.2/.uno/package
// -------------------------------------------------------------------------------------------------
...
{
    FuseNodes_bundle::DrawHelpers4c5c39ae_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[165/*"uniform vec...*/], ::STRINGS[166/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/]));
}
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/.uno/package
// ---------------------------------------------------------------------------------------------------------------
...
{
    FuseReactiveJavaScript_bundle::Diagnostics574485ec_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[167/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[168/*"diagnostics...*/]);
    FuseReactiveJavaScript_bundle::es6promisemin8b510495_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[167/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[169/*"es6-promise...*/]);
    FuseReactiveJavaScript_bundle::Observablecd597ec5_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[167/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[170/*"observable-...*/]);
    FuseReactiveJavaScript_bundle::setTimeout9c842dcd_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[167/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[171/*"settimeout-...*/]);
}
...
static void FuseReactiveJavaScript_bundle_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactiveJavaScript_bundle::Diagnostics574485ec_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactiveJavaScript_bundle::es6promisemin8b510495_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactiveJavaScript_bundle::Observablecd597ec5_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactiveJavaScript_bundle::setTimeout9c842dcd_, uFieldFlagsStatic);
    type->Reflection.SetFields(4,
        new uField("Diagnostics574485ec", 0),
        new uField("es6promisemin8b510495", 1),
        new uField("Observablecd597ec5", 2),
        new uField("setTimeout9c842dcd", 3));
}
...
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactiveJavaScript_bundle::Diagnostics574485ec_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactiveJavaScript_bundle::es6promisemin8b510495_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactiveJavaScript_bundle::Observablecd597ec5_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactiveJavaScript_bundle::setTimeout9c842dcd_;
// }

// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Text/1.0.2/.uno/package
// ------------------------------------------------------------------------------------------------
...
{
    FuseText_bundle::Renderer0b7f7722_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[172/*"uniform mat...*/], ::STRINGS[173/*"uniform vec...*/], 1, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 6, ::STRINGS[6/*"c"*/], ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[10/*"g"*/]));
}
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/UnoCore/1.0.11/.uno/package
// -----------------------------------------------------------------------------------------------
...
{
    UnoCore_bundle::SdfFontShaderc4d110ba_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[180/*"uniform mat...*/], ::STRINGS[181/*"uniform flo...*/], 0, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[12/*"i"*/]));
    UnoCore_bundle::SpriteFontShader901b6a86_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[182/*"uniform mat...*/], ::STRINGS[183/*"uniform sam...*/], 0, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[4/*"a"*/], ::STRINGS[5/*"b"*/], ::STRINGS[6/*"c"*/], ::STRINGS[7/*"d"*/], ::STRINGS[10/*"g"*/]));
}
