...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Common/1.0.2/internal/$.uno
// ----------------------------------------------------------------------------------------------------
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.2/$.uno
// ------------------------------------------------------------------------------------------
...
static void FontFaceDescriptor_build(uType* type)
{
    ...
    ::TYPES[20] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(9/*SequenceEqual<string>*/, ::g::Uno::String_typeof(), NULL);
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.2/internal/$.uno
// ---------------------------------------------------------------------------------------------------
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/internal/$.uno
// ------------------------------------------------------------------------------------------------------
...
static void ImageContainer_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/internal/$.uno");
    ...
    ::TYPES[31] = ::g::Fuse::Resources::FileImageSource_typeof();
    ::TYPES[32] = ::g::Fuse::Resources::HttpImageSource_typeof();
    ::TYPES[33] = ::g::Fuse::Resources::MultiDensityImageSource_typeof();
    ::TYPES[34] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof(), NULL);
    ::TYPES[35] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof(), NULL);
    ::TYPES[36] = ::g::Uno::EventHandler_typeof();
    ::TYPES[37] = ::g::Fuse::Resources::ImageSourceErrorHandler_typeof();
    ::TYPES[38] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::FileSource_typeof(), NULL);
    ::TYPES[39] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::FileSource_typeof(), NULL);
    ::TYPES[40] = ::g::Uno::Collections::RootableList_typeof()->MakeType(::g::Uno::UX::FileSource_typeof(), NULL);
    type->SetFields(0,
        ::g::Uno::Float_typeof(), offsetof(::g::Fuse::Internal::ImageContainer, _density), 0,
        ::TYPES[40/*Uno.Collections.RootableList<Uno.UX.FileSource>*/], offsetof(::g::Fuse::Internal::ImageContainer, _files), 0,
        ...
        ::TYPES[36/*Uno.EventHandler*/], offsetof(::g::Fuse::Internal::ImageContainer, ParamChanged1), 0,
        ::TYPES[36/*Uno.EventHandler*/], offsetof(::g::Fuse::Internal::ImageContainer, SourceChanged1), 0,
        ::TYPES[37/*Fuse.Resources.ImageSourceErrorHandler*/], offsetof(::g::Fuse::Internal::ImageContainer, SourceError1), 0);
}
...
void ImageContainer::CreateMultiDensitySource()
{
    ...
    for (uObject* enum4 = (uObject*)uPtr(_files)->GetEnumerator(); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum4), ::TYPES[23/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::UX::FileSource* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum4), ::TYPES[27/*Uno.Collections.IEnumerator<Uno.UX.FileSource>*/]), &ret14), ret14);
...
void ImageContainer::File(::g::Uno::UX::FileSource* value)
{
    ...
    if (((::g::Uno::Collections::ICollection::Count(uInterface(uPtr(files), ::TYPES[38/*Uno.Collections.ICollection<Uno.UX.FileSource>*/])) == 0) || (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(files), ::TYPES[38/*Uno.Collections.ICollection<Uno.UX.FileSource>*/])) > 1)) || ((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(files), ::TYPES[39/*Uno.Collections.IList<Uno.UX.FileSource>*/]), uCRef<int>(0), &ret18), ret18) != value))
    {
        ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(files), ::TYPES[38/*Uno.Collections.ICollection<Uno.UX.FileSource>*/]));
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(files, ::TYPES[38/*Uno.Collections.ICollection<Uno.UX.FileSource>*/]), value);
    }
}
...
uObject* ImageContainer::Files()
{
    ...
    if (_files == NULL)
    {
        _files = ((::g::Uno::Collections::RootableList*)::g::Uno::Collections::RootableList::New1(::TYPES[40/*Uno.Collections.RootableList<Uno.UX.FileSource>*/]));

        if (IsRooted())
            uPtr(_files)->Subscribe(uDelegate::New(::TYPES[30/*Uno.Action<Uno.UX.FileSource>*/], (void*)ImageContainer__OnFilesChanged_fn, this), uDelegate::New(::TYPES[30/*Uno.Action<Uno.UX.FileSource>*/], (void*)ImageContainer__OnFilesChanged_fn, this));
    }
...
void ImageContainer::add_ParamChanged(uDelegate* value)
{
    ...
    ParamChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ParamChanged1, value), ::TYPES[36/*Uno.EventHandler*/]);
}
...
void ImageContainer::remove_ParamChanged(uDelegate* value)
{
    ...
    ParamChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ParamChanged1, value), ::TYPES[36/*Uno.EventHandler*/]);
}
...
void ImageContainer::ReapplyOptions(::g::Fuse::Resources::ImageSource* src)
{
    ...
    ::g::Fuse::Resources::FileImageSource* f = uAs< ::g::Fuse::Resources::FileImageSource*>(src, ::TYPES[31/*Fuse.Resources.FileImageSource*/]);

    if ((f != NULL) && (MemoryPolicy() != NULL))
        uPtr(f)->DefaultPolicy(MemoryPolicy());

    ::g::Fuse::Resources::HttpImageSource* hf = uAs< ::g::Fuse::Resources::HttpImageSource*>(src, ::TYPES[32/*Fuse.Resources.HttpImageSource*/]);

    if ((hf != NULL) && (MemoryPolicy() != NULL))
        uPtr(hf)->DefaultPolicy(MemoryPolicy());

    ::g::Fuse::Resources::MultiDensityImageSource* mf = uAs< ::g::Fuse::Resources::MultiDensityImageSource*>(Source(), ::TYPES[33/*Fuse.Resources.MultiDensityImageSource*/]);

    if (mf != NULL)

        for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(mf)->Sources()), ::TYPES[34/*Uno.Collections.IEnumerable<Fuse.Resources.ImageSource>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[23/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Resources::ImageSource* s = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[35/*Uno.Collections.IEnumerator<Fuse.Resources.ImageSource>*/]), &ret16), ret16);
            ReapplyOptions(s);
        }
}
...
void ImageContainer::ResampleMode(int value)
{
    ...
    {
        if (value == 2)
            ::g::Fuse::Diagnostics::Deprecated(::STRINGS[5/*"ResampleMod...*/], this, ::STRINGS[3/*"/Users/mart...*/], 295, ::STRINGS[6/*"set_Resampl...*/]);
...
void ImageContainer::add_SourceChanged(uDelegate* value)
{
    ...
    SourceChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(SourceChanged1, value), ::TYPES[36/*Uno.EventHandler*/]);
}
...
void ImageContainer::remove_SourceChanged(uDelegate* value)
{
    ...
    SourceChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(SourceChanged1, value), ::TYPES[36/*Uno.EventHandler*/]);
}
...
void ImageContainer::add_SourceError(uDelegate* value)
{
    ...
    SourceError1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(SourceError1, value), ::TYPES[37/*Fuse.Resources.ImageSourceErrorHandler*/]);
}
...
void ImageContainer::remove_SourceError(uDelegate* value)
{
    ...
    SourceError1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(SourceError1, value), ::TYPES[37/*Fuse.Resources.ImageSourceErrorHandler*/]);
}
...
void ImageContainer::UpdateSourceListen(bool forceOff)
{
    ...
    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[2/*"Switching l...*/], this, ::STRINGS[3/*"/Users/mart...*/], 179, ::STRINGS[4/*"UpdateSourc...*/]);
    ...
    if (should)
    {
        uPtr(_source)->add_Changed(uDelegate::New(::TYPES[36/*Uno.EventHandler*/], (void*)ImageContainer__OnSourceChanged_fn, this));
        uPtr(_source)->add_Error(uDelegate::New(::TYPES[37/*Fuse.Resources.ImageSourceErrorHandler*/], (void*)ImageContainer__OnSourceError_fn, this));
    }
    else
    {
        uPtr(_source)->remove_Changed(uDelegate::New(::TYPES[36/*Uno.EventHandler*/], (void*)ImageContainer__OnSourceChanged_fn, this));
        uPtr(_source)->remove_Error(uDelegate::New(::TYPES[37/*Fuse.Resources.ImageSourceErrorHandler*/], (void*)ImageContainer__OnSourceError_fn, this));
    }
}
...
uString* ImageContainer::Url()
{
    ...
    ::g::Fuse::Resources::HttpImageSource* http = uAs< ::g::Fuse::Resources::HttpImageSource*>(Source(), ::TYPES[32/*Fuse.Resources.HttpImageSource*/]);
...
static void MiniList_build(uType* type)
{
    ...
    ::TYPES[41] = ::g::Uno::Collections::List_typeof();
...
{
    ::TYPES[43] = ::g::Uno::Collections::LinkedList_typeof()->MakeType(::g::Fuse::Internal::SkylineNode_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[43/*Uno.Collections.LinkedList<Fuse.Internal.SkylineNode>*/], offsetof(::g::Fuse::Internal::RectPacker, _skyline), 0,
...
void RectPacker::ctor_(::g::Uno::Int2 size)
{
    ...
    Size(size);
    _skyline = ((::g::Uno::Collections::LinkedList*)::g::Uno::Collections::LinkedList::New1(::TYPES[43/*Uno.Collections.LinkedList<Fuse.Internal.SkylineNode>*/]));
