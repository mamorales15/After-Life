...
static void GeneratedApplication_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("192.168.0.102");
    ::STRINGS[2] = uString::Const("/Users/martinmorales/Desktop/After-Life/After Life/After Life.unoproj");
    ::STRINGS[3] = uString::Const("After Life");
