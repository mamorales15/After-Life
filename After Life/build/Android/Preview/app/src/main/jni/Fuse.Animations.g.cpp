...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Animations/1.0.2/$.uno
// -----------------------------------------------------------------------------------------------
...
static void Attractor_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Animations/1.0.2/$.uno");
...
void Attractor::Motion(::g::Fuse::Motion::DestinationMotion* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[1/*"Motion shou...*/], this, ::STRINGS[2/*"/Users/mart...*/], 201, ::STRINGS[3/*"set_Motion"*/], NULL);
}
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Common/1.0.2/$.uno
// -------------------------------------------------------------------------------------------
...
void MasterBase::Register(::g::Fuse::Animations::MixerHandle* handle)
{
    ...
    if (_inactive)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[9/*"Attempt to ...*/], this, ::STRINGS[2/*"/Users/mart...*/], 1636, ::STRINGS[10/*"Register"*/]);
        return;
    }
...
void MasterProperty::GiveOriginSetterWarning()
{
    ...
    {
        _warningGiven = true;
        ::g::Fuse::Diagnostics::UserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[11/*"The property "*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(Property)->Name())), ::STRINGS[12/*" of "*/]), uPtr(Property)->Object()), ::STRINGS[13/*" cannot be ...*/]), this, ::STRINGS[2/*"/Users/mart...*/], 1793, ::STRINGS[14/*"GiveOriginS...*/]);
    }
}
// }
...
void ResizeAnimatorState::ctor_2(::g::Fuse::Animations::Resize* r, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    if (_target == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Resize star...*/], r, ::STRINGS[2/*"/Users/mart...*/], 2754, ::STRINGS[19/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if (_relativeTo == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[20/*"Resize star...*/], r, ::STRINGS[2/*"/Users/mart...*/], 2762, ::STRINGS[19/*".ctor"*/]);
        _valid = false;
        return;
    }
