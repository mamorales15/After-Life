...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Triggers/1.0.2/$.uno
// ---------------------------------------------------------------------------------------------
...
static void Busy_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Triggers/1.0.2/$.uno");
...
void Busy::UpdateState()
{
    ...
    if ((_rootOn & 1) == 1)
    {
        ...
        {
            _rootOn = (_rootOn & -2);
            ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"On='Paramet...*/], this, ::STRINGS[3/*"/Users/mart...*/], 203, ::STRINGS[7/*"UpdateState"*/], NULL);
        }
        else
...
void Busy::activate(::g::Fuse::Scripting::Context* c, Busy* b, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[2/*"Busy.activa...*/], b, ::STRINGS[3/*"/Users/mart...*/], 264, ::STRINGS[0/*"activate"*/], NULL);
        return;
    }
...
void Busy::deactivate(::g::Fuse::Scripting::Context* c, Busy* b, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"Busy.deacti...*/], b, ::STRINGS[3/*"/Users/mart...*/], 282, ::STRINGS[1/*"deactivate"*/], NULL);
        return;
    }
...
void Completed::reset(::g::Fuse::Scripting::Context* c, Completed* cp, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[11/*"Completed.r...*/], cp, ::STRINGS[3/*"/Users/mart...*/], 824, ::STRINGS[10/*"reset"*/], NULL);
        return;
    }
...
uObject* BusyTaskModule__ConstructorClosure::Construct(uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[12/*"Use the `Bu...*/], this, ::STRINGS[3/*"/Users/mart...*/], 580, ::STRINGS[13/*"Construct"*/]);
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/1.0.2/triggers/$.uno
// -----------------------------------------------------------------------------------------------------------------
...
static void ContainingText_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/1.0.2/triggers/$.uno");
...
{
    ctor_6();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[16/*"Use the tri...*/], this, ::STRINGS[17/*"/Users/mart...*/], 79, ::STRINGS[18/*".ctor"*/]);
}
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/1.0.2/triggers/$.uno
// -----------------------------------------------------------------------------------------------------------------
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Triggers/1.0.2/actions/$.uno
// -----------------------------------------------------------------------------------------------------
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls/1.0.2/triggers/$.uno
// ------------------------------------------------------------------------------------------------------
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/triggers/$.uno
// ------------------------------------------------------------------------------------------------------
...
static void LayoutAnimation_build(uType* type)
{
    ...
    ::STRINGS[20] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/triggers/$.uno");
...
void LayoutAnimation__OnRooted_fn(LayoutAnimation* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[19/*"LayoutAnima...*/], __this, ::STRINGS[20/*"/Users/mart...*/], 228, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/1.0.2/$.uno
// -----------------------------------------------------------------------------------------------
...
static void OnUserEvent_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/1.0.2/$.uno");
    ::STRINGS[21] = uString::Const("OnRooted");
...
void OnUserEvent__OnRooted_fn(OnUserEvent* __this)
{
    ...
    if (::g::Uno::String::op_Equality(::g::Uno::UX::Selector__op_Implicit1(__this->EventName()), NULL))
        ::g::Fuse::Diagnostics::UserError(::STRINGS[22/*"OnUserEvent...*/], __this, ::STRINGS[23/*"/Users/mart...*/], 99, ::STRINGS[21/*"OnRooted"*/], NULL);
    else
    {
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.WebView/1.0.2/$.uno
// -----------------------------------------------------------------------------------------------------
...
static void PageBeginLoading_build(uType* type)
{
    ...
    ::STRINGS[25] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.WebView/1.0.2/$.uno");
    ::STRINGS[21] = uString::Const("OnRooted");
...
void PageBeginLoading__OnRooted_fn(PageBeginLoading* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[31/*Fuse.Controls.IWebView*/]))
    {
        ...
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[24/*"WebView"*/], __this->Parent(), __this, ::STRINGS[25/*"/Users/mart...*/], 1058, ::STRINGS[21/*"OnRooted"*/]);
}
...
void PageLoaded__OnRooted_fn(PageLoaded* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[31/*Fuse.Controls.IWebView*/]))
    {
        ...
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[24/*"WebView"*/], __this->Parent(), __this, ::STRINGS[25/*"/Users/mart...*/], 1117, ::STRINGS[21/*"OnRooted"*/]);
}
...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[26/*"Double remo...*/], __this, ::STRINGS[3/*"/Users/mart...*/], 1742, ::STRINGS[27/*"Fuse.IBegin...*/]);
        return;
    }
...
void RemovingAnimation::OnDone()
{
    ...
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[28/*"Unexpected ...*/], this, ::STRINGS[3/*"/Users/mart...*/], 1755, ::STRINGS[29/*"OnDone"*/]);
        return;
    }
...
static void Scrolled_build(uType* type)
{
    ...
    ::STRINGS[32] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/1.0.2/triggers/$.uno");
...
void Scrolled__OnRooted_fn(Scrolled* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Scrolled co...*/], __this, ::STRINGS[32/*"/Users/mart...*/], 288, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }
...
void Scrolled::check(::g::Fuse::Scripting::Context* c, Scrolled* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[31/*"check takes...*/], s, ::STRINGS[32/*"/Users/mart...*/], 242, ::STRINGS[30/*"check"*/], NULL);
        return;
    }
...
void State::Goto()
{
    ...
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[36/*"Cannot call...*/], NULL, ::STRINGS[3/*"/Users/mart...*/], 2161, ::STRINGS[37/*"Goto"*/]);
        return;
    }
...
void StateGroup::goto_(::g::Fuse::Scripting::Context* c, StateGroup* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[39/*"StateGroup....*/], n, ::STRINGS[3/*"/Users/mart...*/], 1825, ::STRINGS[40/*"goto_"*/], NULL);
        return;
    }
...
void StateGroup::gotoName(::g::Fuse::Scripting::Context* c, StateGroup* n, uString* name)
{
    ...
    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[41/*"Unable to f...*/], name), n, ::STRINGS[3/*"/Users/mart...*/], 1805, ::STRINGS[42/*"gotoName"*/], NULL);
        return;
    }
...
void TextInputActionTriggered__OnRooted_fn(TextInputActionTriggered* __this)
{
    ...
    if (__this->_textEdit == NULL)
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"TextInputAc...*/], __this, ::STRINGS[17/*"/Users/mart...*/], 126, ::STRINGS[21/*"OnRooted"*/], NULL);
    else
...
void Timeline::playTo(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"Timeline.se...*/], n, ::STRINGS[3/*"/Users/mart...*/], 2587, ::STRINGS[50/*"playTo"*/], NULL);
        return;
    }
...
void Timeline::seek(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"Timeline.se...*/], n, ::STRINGS[3/*"/Users/mart...*/], 2636, ::STRINGS[52/*"seek"*/], NULL);
        return;
    }
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/1.0.2/$.uno
// --------------------------------------------------------------------------------------------------------
...
static void TransitionGroup_build(uType* type)
{
    ...
    ::STRINGS[57] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/1.0.2/$.uno");
...
TransitionGroup* TransitionGroup::Root(::g::Fuse::Triggers::Transition* t)
{
    ...
    if (nav == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[56/*"Transition ...*/], t, ::STRINGS[57/*"/Users/mart...*/], 2777, ::STRINGS[58/*"Root"*/], NULL);
        return NULL;
    }
    ...
    if (vis == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[59/*"Transition ...*/], t, ::STRINGS[57/*"/Users/mart...*/], 2784, ::STRINGS[58/*"Root"*/], NULL);
        return NULL;
    }
...
void Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[60/*"Trigger.OnP...*/], __this, ::STRINGS[3/*"/Users/mart...*/], 2930, ::STRINGS[61/*"Fuse.Animat...*/]);
        return;
    }
...
void WhileContainsText__OnRooted_fn(WhileContainsText* __this)
{
    ...
    if (__this->_value != NULL)
    {
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[63/*"No TextInpu...*/], __this, ::STRINGS[17/*"/Users/mart...*/], 51, ::STRINGS[21/*"OnRooted"*/], NULL);
}
...
void WhilePageLoading__OnRooted_fn(WhilePageLoading* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[31/*Fuse.Controls.IWebView*/]))
    {
        ...
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[24/*"WebView"*/], __this->Parent(), __this, ::STRINGS[25/*"/Users/mart...*/], 836, ::STRINGS[21/*"OnRooted"*/]);
}
...
void WhileScrolled__OnRooted_fn(WhileScrolled* __this)
{
    ...
    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Scrolled co...*/], __this, ::STRINGS[32/*"/Users/mart...*/], 795, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }
...
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[64/*"`Pulse` on ...*/], this, ::STRINGS[3/*"/Users/mart...*/], 4300, ::STRINGS[65/*"Pulse"*/]);
...
void WhileVisibleInScrollView__OnRooted_fn(WhileVisibleInScrollView* __this)
{
    ...
    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[66/*"Could not f...*/], __this, ::STRINGS[32/*"/Users/mart...*/], 900, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }
    ...
    if (__this->_element == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[67/*"Parent must...*/], __this, ::STRINGS[32/*"/Users/mart...*/], 907, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }

    if (!uPtr(__this->_element)->HasLayoutIn(__this->_scrollable))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[68/*"Must have a...*/], __this, ::STRINGS[32/*"/Users/mart...*/], 913, ::STRINGS[21/*"OnRooted"*/], NULL);
        return;
    }
