...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Expressions/1.0.2/$.uno
// ---------------------------------------------------------------------------------------------------------
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/$.uno
// --------------------------------------------------------------------------------------------------------
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/1.0.2/$.uno
// ------------------------------------------------------------------------------------------------------
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/fusejs/$.uno
// ---------------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[11] = uString::Const("../../../Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/fusejs/$.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 1, ::STRINGS[11/*"../../../Li...*/], 135);
    return NULL;
}
...
uObject* Console::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[12/*"null"*/], 1, ::STRINGS[11/*"../../../Li...*/], 121);
...
static void DataBinding_build(uType* type)
{
    ...
    ::STRINGS[31] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/1.0.2/$.uno");
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if (::g::Fuse::Marshal::TryConvertTo(uPtr(Target())->PropertyType(), newValue, &res, this))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[31/*"/Users/mart...*/], 409, ::STRINGS[33/*"TryPushAsMa...*/], NULL);
        }
    }
}
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/1.0.2/subscription/$.uno
// -------------------------------------------------------------------------------------------------------------------
...
uObject* DebugLog::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[12/*"null"*/], 1, ::STRINGS[11/*"../../../Li...*/], 99);
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Reactive/1.0.2/$.uno
// ---------------------------------------------------------------------------------------------
...
void Instantiator::AddTemplate(uObject* data, ::g::Uno::UX::Template* f, ::g::Uno::Collections::List* newElements)
{
    ...
    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[45/*"Template co...*/], this, ::STRINGS[31/*"/Users/mart...*/], 1588, ::STRINGS[46/*"AddTemplate"*/]);
        return;
    }
...
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[47/*"Limit canno...*/], this, ::STRINGS[31/*"/Users/mart...*/], 1078, ::STRINGS[48/*"set_Limit"*/], NULL);
        value = 0;
    }
...
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[49/*"Offset cann...*/], this, ::STRINGS[31/*"/Users/mart...*/], 1030, ::STRINGS[50/*"set_Offset"*/], NULL);
        value = 0;
    }
...
{
    ctor_5();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[101/*"'Select' is...*/], this, ::STRINGS[31/*"/Users/mart...*/], 2447, ::STRINGS[102/*".ctor"*/]);
}
...
static void Observable__Subscription_build(uType* type)
{
    ...
    ::STRINGS[105] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/$.uno");
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[104/*"Unexpected ...*/], this, ::STRINGS[105/*"/Users/mart...*/], 646, ::STRINGS[106/*"SetExclusive"*/]);
        return;
    }
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[111/*"Skipped Exc...*/], next, this, ::STRINGS[105/*"/Users/mart...*/], 1861, ::STRINGS[112/*"CheckAndThrow"*/]);
...
uObject* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[113/*"JavaScript ...*/], this, ::STRINGS[105/*"/Users/mart...*/], 1431, ::STRINGS[114/*"CreateMirror"*/]);
        return NULL;
    }
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[125/*"ThreadWorke...*/], e, this, ::STRINGS[105/*"/Users/mart...*/], 1757, ::STRINGS[126/*"Run"*/]);
