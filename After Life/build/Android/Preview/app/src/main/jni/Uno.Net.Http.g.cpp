...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Uno.Net.Http/1.0.11/uriparsers/$.uno
// --------------------------------------------------------------------------------------------------------
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Uno.Net.Http/1.0.11/$.uno
// ---------------------------------------------------------------------------------------------
...
static void HttpMessageCache_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("../../../Library/Application Support/Fusetools/Packages/Uno.Net.Http/1.0.11/$.uno");
...
void HttpMessageCache::IsCacheEnabled(bool value)
{
    ...
    if (HttpMessageCache::_isInitialized())
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[22/*"Uno.Net.Htt...*/], 1, ::STRINGS[23/*"../../../Li...*/], 17);
    else
