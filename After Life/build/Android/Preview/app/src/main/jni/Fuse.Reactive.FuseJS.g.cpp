...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Fuse::Scripting::Function* setTimout = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::STRINGS[1/*"fuse-builti...*/], uPtr(::g::FuseReactiveJavaScript_bundle::setTimeout9c842dcd())->ReadAllText()), ::TYPES[2/*Fuse.Scripting.Function*/]);
    ...
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], uPtr(::g::FuseReactiveJavaScript_bundle::es6promisemin8b510495())->ReadAllText());
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], ::STRINGS[4/*"ES6Promise....*/]);
    ::g::Fuse::Reactive::FuseJS::DiagnosticsImplModule::New2();
    ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactiveJavaScript_bundle::Diagnostics574485ec()))->EvaluateExports(context, ::STRINGS[5/*"FuseJS/Diag...*/]);
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactiveJavaScript_bundle::Observablecd597ec5()))->EvaluateExports(context, ::STRINGS[6/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
static void DiagnosticsImplModule_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/fusejs/$.uno");
...
uObject* DiagnosticsImplModule::Report(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Report requ...*/], this, ::STRINGS[13/*"/Users/mart...*/], 249, ::STRINGS[14/*"Report"*/]);
        return NULL;
    }
...
uObject* TimerModule::Delete(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[38/*Fuse.MarshalException*/]))
        {
            ...
            ::g::Fuse::Diagnostics::UserWarning(::STRINGS[48/*"Timer.delet...*/], this, ::STRINGS[13/*"/Users/mart...*/], 829, ::STRINGS[49/*"Delete"*/]);
        }
        else throw __t;
    }
