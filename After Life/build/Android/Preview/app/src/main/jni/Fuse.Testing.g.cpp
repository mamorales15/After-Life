...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Testing/1.0.2/$.uno
// --------------------------------------------------------------------------------------------
...
{
    ::STRINGS[2] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Testing/1.0.2/$.uno");
...
void UnoTestingHelper__TestFailure::Fail()
{
    ...
    ::g::Uno::Testing::Assert::Fail(_message, ::STRINGS[2/*"/Users/mart...*/], 34, ::STRINGS[3/*"Fail"*/]);
}
...
void TestRootPanel::RunTest()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Diagnostic*> > enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_errors), &ret7), ret7); enum2.MoveNext(::TYPES[9/*Uno.Collections.List<Fuse.Diagnostic>.Enumerator*/]); )
    {
        ...
        ::g::Uno::Testing::Assert::Fail(uPtr(e1)->ToString(), ::STRINGS[2/*"/Users/mart...*/], 190, ::STRINGS[4/*"RunTest"*/]);
    }
