...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/$.uno
// ---------------------------------------------------------------------------------------------
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/caching/$.uno
// -----------------------------------------------------------------------------------------------------
...
static void Element_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/$.uno");
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Draw called...*/], __this, ::STRINGS[9/*"/Users/mart...*/], 890, ::STRINGS[13/*"Draw"*/]);
...
::g::Uno::Graphics::Framebuffer* Element::CaptureRegion(::g::Fuse::DrawContext* dc, ::g::Uno::Rect region, ::g::Uno::Float2 padding)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[5/*"CaptureRegi...*/], uBox(::g::Uno::Int2_typeof(), fsz)), ::STRINGS[6/*", max-size: "*/]), uBox<int>(::g::Uno::Int_typeof(), ::g::Uno::Graphics::Texture2D::MaxSize())), 1, ::STRINGS[7/*"../../../Li...*/], 866);
        return NULL;
    }
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!flat && !_warnOpacityFlat)
    {
        ...
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[8/*"This elemen...*/], this, ::STRINGS[9/*"/Users/mart...*/], 1052, ::STRINGS[10/*"Composit"*/]);
    }
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[11/*"This elemen...*/], this, ::STRINGS[9/*"/Users/mart...*/], 1060, ::STRINGS[10/*"Composit"*/]);
    }
}
...
void ElementBatcher::UpdateDrawList()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Visual*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret27), ret27); enum4.MoveNext(::TYPES[51/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]); )
    {
        ...
        if (emitNewBatch || (atlas == NULL))
        {
            ...
            {
                ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[24/*"BUG: atlas-...*/], 1, ::STRINGS[25/*"../../../Li...*/], 1081);
...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls/1.0.2/$.uno
// ---------------------------------------------------------------------------------------------
