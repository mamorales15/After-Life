...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/UnoCore/1.0.11/targets/android/uno/base/$.uno
// -----------------------------------------------------------------------------------------------------------------
...
static void JNI_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("../../../Library/Application Support/Fusetools/Packages/UnoCore/1.0.11/targets/android/uno/base/$.uno");
...
// public static Android.Base.Primitives.jfieldID GetStaticFieldID(Android.Base.Primitives.ujclass cls, string fieldName, string fieldSig) :278
...
// public static Android.Base.Primitives.jfieldID GetStaticFieldID(Android.Base.Primitives.ujclass cls, string fieldName, string fieldSig) [static] :278
...
// {
// static Versions() :1061
static void Versions__cctor__fn(uType* __type)
{
    Versions::_api_ = -1;
    Versions::_release_ = ::STRINGS[7/*"<unknown>"*/];
}

static void Versions_build(uType* type)
{
    ::STRINGS[7] = uString::Const("<unknown>");
    ::STRINGS[8] = uString::Const("android/os/Build$VERSION");
    ::STRINGS[9] = uString::Const("SDK_INT");
    ::STRINGS[10] = uString::Const("I");
    ::STRINGS[11] = uString::Const("RELEASE");
    ::STRINGS[12] = uString::Const("Ljava/lang/String;");
    type->SetFields(0,
...
// public static int get_ApiLevel() :1080
void Versions__get_ApiLevel_fn(int* __retval)
{
    *__retval = Versions::ApiLevel();
}

// private static void Initialize() :1063
...
// private static void Initialize() [static] :1063
void Versions::Initialize()
{
    ...
    if (Versions::_api() == -1)
    {
        jclass tmpCls = ::g::Android::Base::JNI::LoadClass3(::STRINGS[8/*"android/os/...*/], false);
        jfieldID sdk = ::g::Android::Base::JNI::GetStaticFieldID(tmpCls, ::STRINGS[9/*"SDK_INT"*/], ::STRINGS[10/*"I"*/]);
        jfieldID release = ::g::Android::Base::JNI::GetStaticFieldID(tmpCls, ::STRINGS[11/*"RELEASE"*/], ::STRINGS[12/*"Ljava/lang/...*/]);
        Versions::_api() = ::g::Android::Base::JNI::GetEnvPtr()->GetStaticIntField(tmpCls,sdk);
        Versions::_release() = ::g::Android::Base::Types::String::JavaToUno1(::g::Android::Base::JNI::GetEnvPtr()->GetStaticObjectField(tmpCls,release));
    }
}

// public static int get_ApiLevel() [static] :1080
