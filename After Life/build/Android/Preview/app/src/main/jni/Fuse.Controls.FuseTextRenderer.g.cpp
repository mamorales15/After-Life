...
// /Users/martinmorales/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/1.0.2/textcontrols/fusetextrenderer/$.uno
// --------------------------------------------------------------------------------------------------------------------------------------
...
static void TextRenderer_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("../../../Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/1.0.2/textcontrols/fusetextrenderer/$.uno");
...
void TextRenderer::AsyncMeasurementsDone(::g::Fuse::Controls::FuseTextRenderer::CacheState* state)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(_cacheState == NULL, ::STRINGS[3/*"this._cache...*/], ::STRINGS[4/*"../../../Li...*/], 606, uArray::New(::TYPES[7/*object[]*/], 0));
    _cacheState = state;
