...
public class AppRoot
{
    ...
    public static void ClearRoot1329(final Object handle)
    {
        ((android.widget.FrameLayout)handle).removeAllViews();
    }
    
    public static Object CreateRootView330()
    {
        android.widget.FrameLayout frameLayout = new android.widget.FrameLayout(com.apps.afterlife.AfterLife.GetRootActivity()) {
        		...
        		public boolean onTouchEvent(android.view.MotionEvent motionEvent) {
        			...
        			ExternedBlockHost.callUno_Fuse_Android_AppRoot_OnTouchEvent__331((Object)motionEvent,UnoHelper.GetUnoObjectRef((Object)motionEvent));
    ...
    public static void SetRootView1332(final Object handle,final Object rootHandle)
    {
