...
public class StatusBarHelper
{
    ...
    public static int GetStatusBarColor351()
    {
    ...
    public static void InstallGlobalListener352()
    {
        Window window = com.fuse.Activity.getRootActivity().getWindow();
        	...
        	new ViewTreeObserver.OnGlobalFocusChangeListener() {
        		...
        		public void onGlobalFocusChanged(View oldFocus, View newFocus) {
        			if (_focusWasEditText)
        				ExternedBlockHost.callUno_Fuse_Android_StatusBarConfig_UpdateStatusBar353();
    ...
    public static boolean SetStatusBarColor354(final int color)
    {
        Window window = com.fuse.Activity.getRootActivity().getWindow();
        if (Build.VERSION.SDK_INT >= 21)
        {
