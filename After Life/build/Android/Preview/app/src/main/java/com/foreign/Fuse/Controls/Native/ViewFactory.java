...
public class ViewFactory
{
    ...
    public static Object InstantiateViewGroupImpl254()
    {
        android.widget.FrameLayout frameLayout = new com.fuse.android.views.ViewGroup(com.apps.afterlife.AfterLife.GetRootActivity());
