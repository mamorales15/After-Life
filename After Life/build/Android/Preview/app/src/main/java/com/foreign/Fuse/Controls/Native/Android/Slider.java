...
public class Slider
{
    ...
    public static void AddChangedCallback194(final UnoObject _this, final Object handle)
    {
        ((android.widget.SeekBar)handle).setOnSeekBarChangeListener(new android.widget.SeekBar.OnSeekBarChangeListener() {
        	public void onProgressChanged(android.widget.SeekBar seekBar, int progress, boolean fromUser) {
        		ExternedBlockHost.callUno_Fuse_Controls_Native_Android_Slider_OnSeekBarChanged195((UnoObject)_this,(double)progress / 1000.0);
        	}
    ...
    public static Object Create196()
    {
    ...
    public static void SetProgress197(final Object handle,final double progress)
    {
